...
import requests
import pandas as pd
import json  # Added this import to handle the formatting
...
def run_pipeline():
    ...
    # Added &format=json to the URL to encourage a standard JSON array
    ...
    while True:
        ...
        if data_response.status_code == 200:
            ...
            # THE FIX: Safely parse standard JSON or JSON Lines
            try:
                data = data_response.json()
            except requests.exceptions.JSONDecodeError:
                # If it throws the "Extra data" error, parse it line-by-line
